...
/* build-hook-start *//*00001*/try { require('/home/jairo-lopes/.vscode/extensions/wallabyjs.console-ninja-1.0.523/out/buildHook/index.js').default({tool: 'nuxt', checkSum: '20883b5607b1fc571a318eEhYZTB8MAgcEVF4HA1UEUgQCWwQB', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///home/jairo-lopes/.vscode/extensions/wallabyjs.console-ninja-1.0.523/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt', checkSum: '20883b5607b1fc571a318eEhYZTB8MAgcEVF4HA1UEUgQCWwQB', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
