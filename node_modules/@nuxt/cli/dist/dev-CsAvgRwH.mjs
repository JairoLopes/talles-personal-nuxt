...
/* build-hook-start *//*00001*/try { require('/home/jairo-lopes/.vscode/extensions/wallabyjs.console-ninja-1.0.527/out/buildHook/index.js').default({tool: 'nuxt', checkSum: '203bbe68770ff2f2a36f6cGUxISxwCBFJUBV8EBAVWVVdSV1YL', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///home/jairo-lopes/.vscode/extensions/wallabyjs.console-ninja-1.0.527/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt', checkSum: '203bbe68770ff2f2a36f6cGUxISxwCBFJUBV8EBAVWVVdSV1YL', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
